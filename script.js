...
//   offset_index = 1;
//   initializeSearchTimeline(offset_index, userInputValue);
//   hisEvent = userInputValue
//   page_buttons_y.style.display = "flex";
//   page_buttons.style.display = "none";
// })

// async function getHistoricalEventsSearch(api_offset, api_event) {
//   const params = {
//       text: api_event,
//       offset: api_offset
//   }
...
// async function initializeSearchTimeline(offset_index_i, event_i){
//   const data = await getHistoricalEventsSearch(offset_index_i, event_i);
//   console.log("Initializing Timeline with the Event:", event_i);
...
// const next_buttonX = document.querySelector(".next-y");
// next_buttonY.addEventListener("click", nextPageY);

// function nextPageY(){
//   offset_index = offset_index + 10;
//   initializeSearchTimeline(offset_index, hisEvent)
// }
